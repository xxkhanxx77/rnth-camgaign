  ...
  theme: {
    extend: {
      colors: {
        ...
        violet: 'oklch(var(--renaiss-violet) / <alpha-value>)',
        mint: 'oklch(var(--renaiss-mint) / <alpha-value>)',
        lemon: 'oklch(var(--renaiss-lemon) / <alpha-value>)',
        coral: 'oklch(var(--renaiss-coral) / <alpha-value>)',
      },
      boxShadow: {
